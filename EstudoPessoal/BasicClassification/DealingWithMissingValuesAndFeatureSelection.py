# -*- coding: utf-8 -*-
"""
Created on Thu Jan  4 09:59:39 2018
...
#Apperantly it is not nan so I need to detect na and change it to nan or something else
#Also I need to select best features in order to be quicker proccessing data
#Mega function does not work with strings in atributes so need to change that too

#Do scatter plot with seaborn
sns.pairplot(dataset, hue="class")
'''
dataset2=pd.get_dummies(dataset.iloc[:,:-1])
dataset2=pd.concat([dataset2,dataset['class']],axis=1)
best_model=ReturnPredictor(dataset2)
